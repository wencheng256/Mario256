...
<title>${message("admin.index.title")} - Powered By TURINGROBOT</title>
...
<body>
	...
	<table class="input">
		<tr>
			...
			<td>
				${systemName}
				<a href="http://www.tuling123.com" class="silver" target="_blank">[${message("admin.index.license")}]</a>
			</td>
			<th>
		...
		<tr>
			...
			<td>
				<a href="http://www.tuling123.com" target="_blank">http://www.tuling123.com</a>
			</td>
			<th>
				${message("admin.index.bbs")}:
			</th>
			<td>
				<a href="http://bbs.tuling123.com" target="_blank">http://bbs.tuling123.com</a>
			</td>
		</tr>
		<tr>
			<td colspan="4">

...
import cn.mario256.blog.Order;
import cn.mario256.blog.Pageable;
import cn.mario256.blog.dao.BaseDao;
import cn.mario256.blog.entity.OrderEntity;
import cn.mario256.blog.Filter;
import cn.mario256.blog.Order;
import cn.mario256.blog.Page;
import cn.mario256.blog.Pageable;
import cn.mario256.blog.dao.BaseDao;
...
public abstract class BaseDaoImpl<T extends BaseEntity<ID>, ID extends Serializable> implements BaseDao<T, ID> {
	...
	/** 别名前缀 */
	private static final String ALIAS_PREFIX = "turingGeneratedAlias";

...
public class DatabaseNamingStrategy extends DefaultComponentSafeNamingStrategy {
    ...
    private static final String DEFAULT_TABLE_PREFIX = "tl_";
    private static final Boolean DEFAULT_IS_ADD_UNDERSCORES = true;
    private static final Integer DEFAULT_MAX_LENGTH = 128;

    private String tablePrefix = DEFAULT_TABLE_PREFIX;// 数据库表名前缀
    private Boolean isAddUnderscores = DEFAULT_IS_ADD_UNDERSCORES;// 是否以下划线形式命名
    private Integer maxLength = DEFAULT_MAX_LENGTH;// 命名最大长度限制
